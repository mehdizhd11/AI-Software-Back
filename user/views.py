...
class ChangePasswordView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            ...
            400: openapi.Response("Invalid input or incorrect old password",
                                  examples={"application/json": {"error": "Old password is incorrect."}}),
    ...
    @swagger_auto_schema(
        ...
        responses={
            201: openapi.Response("Customer created successfully",
                                  examples={"application/json": {"message": "Customer created successfully"}}),
            400: openapi.Response("Invalid input", examples={
                "application/json": {"phone_number": ["A user with this phone number already exists."],
...
class RestaurantSignUpView(APIView):
    ...
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            ...
            properties={
                'phone_number': openapi.Schema(type=openapi.TYPE_STRING,
                                               description="Phone number of the restaurant manager."),
                'password': openapi.Schema(type=openapi.TYPE_STRING,
                                           description="Password for the restaurant manager account."),
                'name': openapi.Schema(type=openapi.TYPE_STRING, description="Name of the restaurant."),
                'business_type': openapi.Schema(type=openapi.TYPE_STRING,
                                                description="Type of business the restaurant operates."),
        ...
        responses={
            201: openapi.Response("Restaurant Manager created successfully", examples={
                "application/json": {"message": "Restaurant Manager created successfully"}}),
            400: openapi.Response("Invalid input", examples={
                "application/json": {"phone_number": ["A user with this phone number already exists."],
                                     "password": ["This field is required."]}}),
            500: openapi.Response("Internal server error"),
